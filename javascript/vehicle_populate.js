$.getScript("ajax/vehicle_data.json", function(){
 ...
 for(var i = 0; i < length; i++){
    if(i%2 === 0)
            ...
            html += '<p>Total ' + carInfo[i]['carPrice'] + ' USD</p>';
            html += '</div>';
            html += '</li>';
            html += '<li class = "carimage">';
            html += '<img src="images/vehicles/car' + (i+1) + '.gif" alt="car1">';
            html += '<p class = "carsize">' + carInfo[i]['carSize'] + '</p>';
            html += '</li>';
            html += '<li class = "capacity">';
            html += '<div>';
            html += '<img src="images/icon_man.gif" alt="man"> x ' + carInfo[i]['passengers'] + ' Passengers<br>';
            html += ' <img src="images/icon_sm_scase.gif" alt="man"> x ' + carInfo[i]['smallSuitcase'] + ' Small Suitcases<br>';
            html += '<img src="images/icon_lg_scase.gif" alt="man"> x ' + carInfo[i]['largeSuitcase'] + ' Large Suitcase<br>';
            html += '</div>';
            html += '</li>';
